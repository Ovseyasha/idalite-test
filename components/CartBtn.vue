<template>
  <button class="product__add" @click="move">
    <svg width="12" height="14" viewBox="0 0 12 14" xmlns="http://www.w3.org/2000/svg" :fill="!inCart ? '#959DAD' : 'red'">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd" d="M0 3.5C0 3.16863 0.268629 2.9 0.6 2.9H11.4C11.7314 2.9 12 3.16863 12 3.5C12 3.83137 11.7314 4.1 11.4 4.1H0.6C0.268629 4.1 0 3.83137 0 3.5Z" />
...
export default {
  ...
  mounted () {
    // await this.$store.dispatch('cart/read')
    this.inCart = this.$store.getters['cart/hasIt'](this.id)
  },
  methods: {
    move () {
      if (this.inCart) {
